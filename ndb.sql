...
-- 테이블 데이터 jung.test:~6 rows (대략적) 내보내기
...
INSERT INTO `test` (`b_idx`, `b_title`, `b_content`, `b_date`, `b_writer`, `u_idx`) VALUES
	...
	(37, 'bvbcvbcv', 'sdfsdf', '2021-11-11 09:07:14', '', NULL),
	(38, 'qweqw', 'qwee', '2021-11-11 09:07:21', '', NULL),
	(39, 'mmmm', 'mmmmmmmmm', '2021-11-11 09:07:27', '', NULL);
