...
INSERT INTO `test` (`b_idx`, `b_title`, `b_content`, `b_date`, `u_idx`, `b_hit`, `groups`, `orders`, `depth`) VALUES
	...
	(114, '글2', 'ㅇㅇㅇ', '2021-11-19 05:21:32', 11, 23, 114, 1, 0),
...
-- 테이블 데이터 jung.test_reply:~3 rows (대략적) 내보내기
...
INSERT INTO `test_reply` (`c_num`, `b_idx`, `u_idx`, `c_date`, `c_content`, `groups`, `orders`, `depth`) VALUES
	(104, 119, 11, '2021-11-25 08:55:37', '11', 104, 1, 0),
	(105, 119, 11, '2021-11-25 08:55:41', '12', 104, 7, 1),
	(106, 119, 11, '2021-11-25 08:55:44', '13', 104, 2, 1),
	(107, 119, 11, '2021-11-25 08:55:48', '131', 104, 4, 2),
	(109, 119, 11, '2021-11-25 08:55:58', '1312', 104, 5, 3),
	(110, 119, 11, '2021-11-25 08:56:03', '132', 104, 3, 2),
	(111, 119, 11, '2021-11-25 08:56:09', '22', 111, 1, 0);
